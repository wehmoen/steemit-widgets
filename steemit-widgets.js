                ...
                if (!err && profile.length) {
                    ...
                    steem.api.getFollowCount(settings.user, function(err, followers) {
                        var template = steemitWidgets.getTemplate(settings.template)
                            ...
                            .replace(/\${IMAGE}/gi, metaData.profile_image ? 'https://images.hive.blog/2048x512/' + metaData.profile_image : '')
                            .replace(/\${COVERIMAGE}/gi, metaData.cover_image ? 'https://images.hive.blog/2048x512/' + metaData.cover_image : '')
...
steemitWidgets.blog = function(options) {
    var settings = Object.assign({
        ...
        defaultImage: 'https://images.hive.blog/DQmXYX9hqSNcikTK8ARb61BPnTk4CKMhaiqr22iCKD8CKsp/steemit-logo.png',
                ...
                if (!err && posts.length) {
                    ...
                    for (var i = 0; i < posts.length; i++) {
                        ...
                        var template = steemitWidgets.getTemplate(settings.template)
                            ...
                            .replace(/\${IMAGE}/gi, metaData.image ? 'https://images.hive.blog/2048x512/' + metaData.image[0] : settings.defaultImage)
